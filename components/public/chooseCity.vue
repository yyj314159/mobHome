    ...
    <div class="choose-city-tab" :style="{width:width}">
        ...
        <div class="main-page" v-if="comeFromMain">
           <div class="main-title">
               <img src="/images/gobackpng.png" alt="" @click="$emit('isShowCity',false)">
               选择地址
           </div>
...
<script>
    ...
    export default {
        ...
        mounted(){
            ...
            let cityTabArr = Array.from(document.querySelectorAll(".body-content"));
            cityTabArr.forEach((_this)=>{
                _this.style.height = WinH-h1-h2-h3+"px";
            });
            if(this.comeFromMain){
                let h4 = document.querySelector(".main-page").offsetHeight;
                cityTabArr.forEach((_this)=>{
                    _this.style.height = WinH-h2-h4+"px";
                });
            };
            this.HttpCli.post(
...
.choose-city-tab{
    ...
    .primary-letter{
        ...
        .selected{
            color:#3D9BE9;
            background: url("/images/dui.png") no-repeat 250px center;
